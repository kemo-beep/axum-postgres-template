...
pub enum ApiError {
    ...
    /// Conflict: duplicate, precondition failed (409).
    #[error("Conflict: {0}")]
    Conflict(String),
...
impl IntoResponse for ApiError {
    fn into_response(self) -> Response {
        // Log detailed error for telemetry (never expose internals to client).
        ...
        // Determine the appropriate status code per REST conventions.
